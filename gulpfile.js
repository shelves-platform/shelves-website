...
function modules() {
  ...
  // Static images
  var staticImgs = gulp.src('./img/*').pipe(gulp.dest('./dist/img'));

  // Index!
  var index = gulp.src('./index.html').pipe(gulp.dest('./dist/'))
  return merge(bootstrap, fontAwesomeCSS, fontAwesomeWebfonts, jquery, jqueryEasing, simpleLineIconsFonts, simpleLineIconsCSS, staticImgs, index);
}
